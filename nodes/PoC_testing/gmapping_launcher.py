...
class gmapping_launcher(object):
    ...
    def metaTopic_callback(self, data):
        if data.type == "sensor_msgs/LaserScan":
            ...
            self.subprocs.append(subprocess.Popen(["rosrun","gray_transceiver", "lidar_remapper.py", "__ns:="+namePieces[0],"_namespace:="+namePieces[0]], stdin=subprocess.PIPE, stdout=subprocess.PIPE))
